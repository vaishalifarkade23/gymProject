...
<html lang="en">
  <head>
    ...
    <title>register as Trainer</title>
					...
					<div class="col-sm-12">
						...
						<div class="row">
							<div class="col-sm-4 form-group">
								<label>Age</label>
								<input type="text" placeholder="Enter Age Here.." class="form-control">
							</div>	
							<div class="col-sm-4 form-group">
								<label>Height</label>
							...
							<div class="col-sm-4 form-group">
								<label>Weight</label>
								<input type="text" placeholder="Enter Weight Here.." class="form-control">
							</div>		
						</div>
						<div class="row">
							<div class="col-sm-6 form-group">
								<label>Certified from</label>
								 <select name="combotype" class="form-control" id="certified">
